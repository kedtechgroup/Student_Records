    ...
    <div>
        <div class="row" v-if="showCreateForm">
            <div class="col-md-6 offset-md-2">
                <form class="card" @submit.prevent="createSubject">
        ...
        <div class="row" v-if="showUpdateForm">
            <div class="col-md-6 offset-md-2">
                <form class="card" @submit.prevent="updateSubject">
                    <div class="card-header bg-transparent">
                        <h6 class="card-title">Update Subject Details</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">Name</label>
                            ...
                            <div class="list-icons custom-actions">
                                <div class="list-icons-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="#" class="dropdown-item"
                                           @click.prevent="deleteSubject(props.rowData, props.rowIndex)">
    ...
    export default {
        ...
        methods: {
            ...
            deleteSubject(rowData) {
                window.httpClient.delete('/subjects/' + rowData.id)
                    .then(response => {
